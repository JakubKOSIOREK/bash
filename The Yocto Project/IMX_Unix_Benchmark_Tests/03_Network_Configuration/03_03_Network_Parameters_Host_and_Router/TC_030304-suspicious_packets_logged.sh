...
TEST_TITLE="Ensure suspicious packets are logged (Host and Router)"
TEST_ID=030304
EXPECTED_VALUE=1
...
# Check both settings
check_setting "net.ipv4.conf.all.log_martians"
all_result=$?

check_setting "net.ipv4.conf.default.log_martians"
default_result=$?
