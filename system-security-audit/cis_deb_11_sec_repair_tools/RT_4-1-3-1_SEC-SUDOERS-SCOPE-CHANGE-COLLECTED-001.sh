...
repair_id="SEC-AUDIT-SUDO-001"
repair_name="Copy sudo command usage audit rules and load them"
rules="01-scope.rules"
...
echo "DONE;${repair_id};${repair_file};${repair_name};Reguły audytu dotyczące użycia sudo zostały skopiowane i załadowane."
exit 0
